...
def index():
    ...
    dr_counts = df.groupby('direct_report').count()['message']
    dr_names = ['No','Yes']
    categories = df.iloc[:,4:].columns
    categories_count = (df.iloc[:,4:] != 0).sum().values
    ...
    graphs = [
        ...
        }, 
        {
            ...
            'layout': {
                'title': 'Volume of Direct Reports',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
         ...
         },
         {
            ...
            'layout': {
                'title': 'Volume of Message Categories',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
